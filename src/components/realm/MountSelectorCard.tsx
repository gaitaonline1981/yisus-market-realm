...
interface Props { id: string; name: string; type: string; selected: boolean; onSelect: (id: string) => void; color?: string }

export function MountSelectorCard({ id, name, type, selected, onSelect, color = "#F59E0B" }: Props) {
  return (
